...
Handle g_ArrayHittableClones, g_ArrayHittables;
...
{
	if (IsValidInGame(client) && bVision[client])
	{
...
public TankHittablePunched(const char[] output, int caller, int activator, float delay)
{
	int iEntity = caller;
