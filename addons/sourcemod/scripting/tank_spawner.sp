...
int tankCount, iTankPercent, iRoundPercent, spawnScheme, iCvarMinFlow, iCvarMaxFlow;
bool readyUpIsAvailable, hybridScoringAvailable, readyFooterAdded, bAllowTankSpawn, bIsRemix, bValidSpawn[101];
char sCurrentMap[64];
...
{
	int percent = GetNativeCell(1);
	SetTankPercent(percent);
}
